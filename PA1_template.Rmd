...
**The average number of total steps `r avgSteps` and the most frequent number of total steps `r midianSteps` are close to each other. It is the mostly likely for the participants to take this amount of steps every day. It may suggest the total number of steps that the participants usually take is predictable. **
